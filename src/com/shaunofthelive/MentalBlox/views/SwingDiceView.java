...
public class SwingDiceView extends JPanel implements IObserver, IBoardView {
    ...
    public class ResizeListener implements ComponentListener {
        ...
        public void componentResized(ComponentEvent arg0) {
            ...
            ((SwingDiceView) c).resizePanel(height, height);
    ...
    /* CONSTRUCTOR */
    public SwingDiceView(IGameController controller, Game gameModel) {
