...
public class SwingDieView {
    private Box boxModel;
    private Point topLeft;
    private int width;
    private int strokeWidth;

    public SwingDieView(Box boxModel) {
    ...
    public SwingDieView(Box boxModel, int strokeWidth) {
        this.boxModel = boxModel;
        this.topLeft = new Point(0, 0);
        this.width = 0;
    ...
    public SwingDieView(Box boxModel, Point topLeft, int width) {
        this.boxModel = boxModel;
